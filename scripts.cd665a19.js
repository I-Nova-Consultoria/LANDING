...
var _default = function _default() {
  // carousel
  var selector = '.carousel-list';
  var $buttonPrev = document.querySelector('.carousel-buttons .prev');
  var $buttonNext = document.querySelector('.carousel-buttons .next');
  var Carousel = new _siema.default({
    selector: selector,
    perPage: {
      540: 2,
      860: 3
  ...
  $galleries.forEach(function ($wrap) {
    var $gallery = $wrap.querySelector('.carousel-gallery-list');
    var $galleryPrev = $wrap.querySelector('.prev');
    var $galleryNext = $wrap.querySelector('.next');
    var Gallery = new _siema.default({
      selector: $gallery,
      loop: true
    });
...
},{"siema":"../node_modules/siema/dist/siema.min.js"}],"../node_modules/imask/esm/_rollupPluginBabelHelpers-3c58f0e3.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  // focused
  var $wraps = document.querySelectorAll('.input-float');
  ...
  var $inputsPhone = document.querySelectorAll('[type="tel"]');
  $inputsPhone.forEach(function ($input) {
    return (0, _imask.default)($input, {
      mask: '(00) 00000-0000'
    });
  }); // success

  var handleSuccess = function handleSuccess($form) {
    $form.innerHTML = "\n      <div class=\"icon-success\">\n        <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"72px\" height=\"72px\">\n          <g fill=\"none\" stroke=\"#8EC343\" stroke-width=\"2\">\n            <circle cx=\"36\" cy=\"36\" r=\"35\" style=\"stroke-dasharray:240px, 240px; stroke-dashoffset: 480px;\"></circle>\n            <path d=\"M17.417,37.778l9.93,9.909l25.444-25.393\" style=\"stroke-dasharray:50px, 50px; stroke-dashoffset: 0px;\"></path>\n          </g>\n        </svg>\n\n        <p>Obrigado! Em breve, um de nossos Facilitadores entrar\xE1 em contato para solicitar \n        a documenta\xE7\xE3o necess\xE1ria para a an\xE1lise do seu cr\xE9dito imobili\xE1rio.</p>\n      </div>\n    ";
  }; // submit
  ...
  $forms.forEach(function ($form) {
    $form.addEventListener('submit', function (e) {
      ...
      var _number$value$split = number.value.split(' '),
          _number$value$split2 = _slicedToArray(_number$value$split, 2),
          ddd = _number$value$split2[0],
          phone = _number$value$split2[1];
      ...
      var resHC = hc_envia_mensagem('32110', data.name, data.email, data.ddd, data.number, 'Origin: Landing Page - Aprova Fácil');
      var response = JSON.parse(resHC);
...
exports.default = _default;
},{"imask":"../node_modules/imask/esm/index.js"}],"js/animate.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener('DOMContentLoaded', function () {
  // insert hc_dominio_chat
  var wrapHC = document.createElement('script');
  wrapHC.innerHTML = "\n    var hc_dominio_chat = 'inova.housecrm.com.br';\n    var hc_https = 1;\n  ";
  document.body.append(wrapHC); // init modules

  (0, _carousel.default)();
  (0, _form.default)();
  (0, _animate.default)();
});
},{"./carousel":"js/carousel.js","./form":"js/form.js","./animate":"js/animate.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
